...
class AddSetupModeDeviceController {

    private final AddSetupModeDeviceView mView;
    ...
    AddSetupModeDeviceController(AddSetupModeDeviceView view, DeviceCollection deviceCollection, AferoClient aferoClient) {
        mView = view;
    ...
    private static class AddDeviceObserver extends RxUtils.WeakObserver<DeviceModel, AddSetupModeDeviceController> {
        AddDeviceObserver(AddSetupModeDeviceController controller) {
            super(controller);
        }

        @Override
        public void onCompleted(AddSetupModeDeviceController controller) {
        }

        @Override
        public void onError(final AddSetupModeDeviceController controller, Throwable e) {
        ...
        @Override
        public void onNext(final AddSetupModeDeviceController controller, final DeviceModel deviceModel) {
