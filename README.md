...
```Gradle
    implementation 'io.afero.sdk:afero-sdk-core:1.3.1'
```
...
```Gradle
    implementation 'io.afero.sdk:afero-sdk-client-retrofit2:1.3.1'
```

The `afero-sdk-android` module is required for Android development.
```Gradle
    implementation 'io.afero.sdk:afero-sdk-android:1.3.1'
```

The `afero-sdk-softhub` module is required for soft hub functionality on Android.
```Gradle
    implementation 'io.afero.sdk:afero-sdk-softhub:1.3.1'
